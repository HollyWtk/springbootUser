...
public class RedisUtil {
     ...
     * @return 值
     */
    public <T> T hget(String key,Object item, Class<T> clazz){
     ...
     * 删除hash表中的值
     * @param key 键 不能为null
     * @param item 项 可以使多个 为null删除整个hash
     */
    ...
    public Set<String> getAllKeyFromMap(String mapName){
    	
    	Set retKeys = null;
    	try {
    		retKeys =redisTemplate.opsForHash().keys(mapName);
    	}catch (Exception e) {
    		 e.printStackTrace();
    		 return null;
		}
     ...
     * 获取map的size
     */
    public Long maphlen(String key) {
